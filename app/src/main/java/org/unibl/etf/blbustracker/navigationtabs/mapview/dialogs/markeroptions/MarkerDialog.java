...
public class MarkerDialog extends BottomSheetDialogFragment
{
    ...
    private MarkerDialog(MarkerDialogListener markerDialogListener)
    {
        this.markerDialogListener = markerDialogListener;
    }

    public static synchronized MarkerDialog getInstance(MarkerDialogListener markerDialogListener)
    {
        if (markerDialog == null)
            markerDialog = new MarkerDialog(markerDialogListener);
